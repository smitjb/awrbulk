Rem
Rem $Header: rdbms/admin/sprepins.sql /main/61 2013/11/08 09:02:22 kchou Exp $
Rem
Rem sprepins.sql
Rem
...
ttitle off;
btitle off;
set timing off veri off space 1 flush on pause off termout off numwidth 10;
...
define report_name=sp_&inst_name._&begin_snap._&end_snap..lst
set termout off;
...
set space 1 termout off newpage 1;
whenever sqlerror exit;
...
set space 1 termout off newpage 0;
whenever sqlerror exit;
repfooter center -
   '-------------------------------------------------------------';
...
btitle off;
repfooter off;
set linesize 78 termout off feedback 6;
undefine begin_snap
undefine end_snap
undefine dbid
undefine inst_num
